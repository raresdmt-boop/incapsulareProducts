...
public class UserService {
    ...
    public void addCustomer(User user, String billingAddress, String shippingAdress, String phone){
        Customer customer = new Customer(user.getId(), user.getEmail(), user.getPassword(), user.getFullName(), billingAddress, shippingAdress, phone);
