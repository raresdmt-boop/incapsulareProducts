...
public class Order {
    ...
    public Order(String line) {
        ...
        this.amount = Double.parseDouble(props[2]);
    ...
    public Order(int id, int customerId, double amount, String shippingAddress, String orderAddress, String orderEmail, String orderDate, String orderStatus) {
        this.id = id;
